 ...
 */
class LEVELUP_import_init_Plugin {
	/**
	...
	private function set_plugin_constants() {
		...
		if ( ! defined( 'LEVELUP_OCDI_PATH' ) ) {
			define( 'LEVELUP_OCDI_PATH', plugin_dir_path( __FILE__ ) );
		}
		if ( ! defined( 'LEVELUP_OCDI_URL' ) ) {
			define( 'LEVELUP_OCDI_URL', plugin_dir_url( __FILE__ ) );
		}
	...
	/**
	 * Set plugin version constant -> LEVELUP_VERSION.
	 */
	public function set_plugin_version_constant() {
		if ( ! defined( 'LEVELUP_VERSION' ) ) {
			$plugin_data = get_plugin_data( __FILE__ );
			define( 'LEVELUP_VERSION', $plugin_data['Version'] );
		}
	}
}

// Instantiate the plugin class.
$importer_plugin = new LEVELUP_import_init_Plugin();