	...
	function config_deisgn(){
		...
		$this->config = array(
			array(
				...
				'panel'    		=> 'header_panel',
				'title'         => esc_html__('Header 1', HEADER_FOOTER_PLUGIN_TEXT_DOMAIN),
