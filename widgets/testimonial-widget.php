 ...
 *
 * Elementor widget for Testimonial widget.
 *
 * @since 1.0.0
 */
class TestimonialWidgets extends Widget_Base {
	...
	protected function _register_controls() {
		...
		do_action( 'levelup/widgets/fields/html', $this, 'testimonial', 'htmlFields' );
		$this->end_controls_section();
		do_action( 'levelup/widgets/fields/sections', $this, 'testimonial', 'styleFields' );
