 ...
 *
 * Elementor widget for Logo widget.
 *
 * @since 1.0.0
 */
class LogoWidgets extends Widget_Base {
	...
	protected function _register_controls() {
		...
		do_action( 'levelup/widgets/fields/html', $this, 'logo', 'htmlFields' );
		$this->end_controls_section();
		do_action( 'levelup/widgets/fields/sections', $this, 'logo', 'styleFields' );
