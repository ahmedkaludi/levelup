	...
	protected function _register_controls() {
		...
		$this->add_control(
			'heading1', [
				...
				'default' => __( 'We Design Modern' , 'plugin-domain' ),
				'label_block' => true,
				'conditions'=> array(
					'terms'	=> array(
						array(
			...
			[
				...
				'default' => [
					[
						...
						'title-1'=>__( 'We are a firm', 'plugin-domain' ),
						'text_desc1'=>__( 'Nay preference dispatched difficulty continuing joy one. Songs it be if ought hoped of. Too carriage attended him entrance desirous the saw.', 'plugin-domain' ),
					],
					[
						'icon1' => __( 'fa fa-arrows-alt', 'plugin-domain' ),
						'title-1'=>__( 'Our latest work', 'plugin-domain' ),
						'text_desc1'=>__( 'Nay preference dispatched difficulty continuing joy one. Songs it be if ought hoped of. Too carriage attended him entrance desirous the saw.', 'plugin-domain' ),
					],
					[
						'icon1' => __( 'fa fa-laptop', 'plugin-domain' ),
						'title-1'=>__( 'Digital campaign', 'plugin-domain' ),
						'text_desc1'=>__( 'Nay preference dispatched difficulty continuing joy one. Songs it be if ought hoped of. Too carriage attended him entrance desirous the saw.', 'plugin-domain' ),
					],
		...
		// Feature Design 2 Fields //
		 $this->add_control(
			'heading2', [
				'label' => __( 'Heading', 'plugin-domain' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'We are Ready' , 'plugin-domain' ),
				'label_block' => true,
				'conditions'=> array(
					'terms'	=> array(
						array(
		 ...
		 $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXTAREA,
				'rows' => 10,
				'default' => __( 'Blind would equal while oh mr do style. Lain led and fact none. One preferred sportsmen resolving the happiness continued. High at of in loud rich true.', 'plugin-domain' ),
				'placeholder' => __( 'Type your description here', 'plugin-domain' ),
				'conditions'=> array(
					'terms'	=> array(
						array(
		...
		$repeater2->add_control(
		 ...
		 $this->add_control(
			...
			[
				...
				'default' => [
					[
						'title2'=>__( 'Responsive creation', 'plugin-domain' ),
						'text_description2'=>__( 'Certainly elsewhere my do allowance at. The address farther six hearted hundred towards husband. Are securing off.', 'plugin-domain' ),
						'icon2' => __( 'fa fa-angle-right', 'plugin-domain' ),
						'link2' => __( '#', 'plugin-domain' ),
					],
					[
						'title2'=>__( 'Multi-award digital agency', 'plugin-domain' ),
						'text_description2'=>__( 'Certainly elsewhere my do allowance at. The address farther six hearted hundred towards husband. Are securing off.', 'plugin-domain' ),
						'icon2' => __( 'fa fa-angle-right', 'plugin-domain' ),
						'link2' => __( '#', 'plugin-domain' ),
					],
					[
						'title2'=>__( 'Web designing', 'plugin-domain' ),
						'text_description2'=>__( 'Certainly elsewhere my do allowance at. The address farther six hearted hundred towards husband. Are securing off..', 'plugin-domain' ),
						'icon2' => __( 'fa fa-angle-right', 'plugin-domain' ),
						'link2' => __( '#', 'plugin-domain' ),
					],
		...
		// Feature Design 3 Fields //
		 $this->add_control(
			'heading3', [
				'label' => __( 'Heading', 'plugin-domain' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'A Global Agency Interactive' , 'plugin-domain' ),
				'label_block' => true,
				'conditions'=> array(
					'terms'	=> array(
						array(
		 ...
		 $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXTAREA,
				'rows' => 10,
				'default' => __( 'Cultivated who resolution connection motionless did occasional. Journey promise if it colonel. Can all mirth abode nor hills added.', 'plugin-domain' ),
				'placeholder' => __( 'Type your description here', 'plugin-domain' ),
				'conditions'=> array(
					'terms'	=> array(
						array(
		 ...
		 $this->add_control(
			'btn_txt', [
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'VIEW DEMO' , 'plugin-domain' ),
				'label_block' => true,
				'conditions'=> array(
					'terms'	=> array(
						array(
			...
			[
				...
				'default' => [
					[
						...
						'text_desc3'=>__( 'Certainly elsewhere my do allowance at. The address farther six hearted hundred towards husband.', 'plugin-domain' ),
					],
					[
						'icon3' => __( 'fa fa-code', 'plugin-domain' ),
						'title-3'=>__( 'Creative', 'plugin-domain' ),
						'text_desc3'=>__( 'Ten now love even supplied feelings mr of dissuade recurred no it offering honoured.', 'plugin-domain' ),
					],
					[
						'icon3' => __( 'fa fa-adjust', 'plugin-domain' ),
						'title-3'=>__( 'Strategy', 'plugin-domain' ),
						'text_desc3'=>__( 'No comfort do written conduct at prevent manners on. Celebrated contrasted him occasional.', 'plugin-domain' ),
					],
		...
		// Feature Design 4 Fields //
		 $this->add_control(
			'heading4', [
				'label' => __( 'Heading', 'plugin-domain' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'We provide Lovely designs' , 'plugin-domain' ),
				'label_block' => true,
				'conditions'=> array(
					'terms'	=> array(
						array(
		 ...
		 $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXTAREA,
				'rows' => 10,
				'default' => __( 'Case read they must it of cold that. Speaking trifling an to unpacked moderate debating learning. An particular contrasted he excellence favourable on.', 'plugin-domain' ),
				'placeholder' => __( 'Type your description here', 'plugin-domain' ),
				'conditions'=> array(
					'terms'	=> array(
						array(
			...
			[
				...
				'default' => [
					[
						...
						'title-4'=>__( 'Our Services', 'plugin-domain' ),
						'text_description4'=>__( 'Certainly elsewhere my do allowance at. The address farther six hearted hundred towards husband.', 'plugin-domain' ),
					],
					[
						'image4' => __( '', 'plugin-domain' ),
						'title-4'=>__( 'Technology', 'plugin-domain' ),
						'text_description4'=>__( 'Certainly elsewhere my do allowance at. The address farther six hearted hundred towards husband.', 'plugin-domain' ),
					],
					[
						'image4' => __( '', 'plugin-domain' ),
						'title-4'=>__( 'New Designs', 'plugin-domain' ),
						'text_description4'=>__( 'Certainly elsewhere my do allowance at. The address farther six hearted hundred towards husband.', 'plugin-domain' ),
					],
		...
		$this->add_control(
			'button4', [
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'Get Started with Designs' , 'plugin-domain' ),
				'label_block' => true,
				'conditions'=> array(
					'terms'	=> array(
						array(
		...
		// Feature Design 5 Fields //
		 $this->add_control(
			'heading5', [
				'label' => __( 'Heading', 'plugin-domain' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'A Global Agency' , 'plugin-domain' ),
				'label_block' => true,
				'conditions'=> array(
					'terms'	=> array(
						array(
			...
			[
				...
				'default' => [
					[
						...
						'title-5'=>__( 'Strategy', 'plugin-domain' ),
						'text_desc5'=>__( 'Promotion an ourselves up otherwise my. High what each snug rich far yet easy. In companions inhabiting mr principles at insensible do. Heard their sex hoped enjoy vexed child for', 'plugin-domain' ),
					],
					[
						'icon5' => __( 'fa fa-soccer-ball-o', 'plugin-domain' ),
						'title-5'=>__( 'Creative Services', 'plugin-domain' ),
						'text_desc5'=>__( 'Promotion an ourselves up otherwise my. High what each snug rich far yet easy. In companions inhabiting mr principles at insensible do. Heard their sex hoped enjoy vexed child for', 'plugin-domain' ),
					],
					[
						'icon5' => __( 'fa fa-location-arrow', 'plugin-domain' ),
