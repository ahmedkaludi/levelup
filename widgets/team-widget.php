 ...
 *
 * Elementor widget for Team widget.
 *
 * @since 1.0.0
 */
class TeamWidgets extends Widget_Base {
	...
	protected function _register_controls() {
		...
		do_action( 'levelup/widgets/fields/html', $this, 'team', 'htmlFields' );
		$this->end_controls_section();
		do_action( 'levelup/widgets/fields/sections', $this, 'team', 'styleFields' );
