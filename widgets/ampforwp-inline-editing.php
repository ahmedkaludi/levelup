 ...
 * @since 1.1.0
 */
class Ampforwp_Inline_Editing extends Widget_Base {
	...
	public function get_title() {
		return __( 'Inline Editing', 'ampforwp-elementor-plus' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Content', 'ampforwp-elementor-plus' ),
			]
		);
		...
		$this->add_control(
			'title',
			[
				'label' => __( 'Title', 'ampforwp-elementor-plus' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Title', 'ampforwp-elementor-plus' ),
			]
		);
		...
		$this->add_control(
			'description',
			[
				'label' => __( 'Description', 'ampforwp-elementor-plus' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( 'Description', 'ampforwp-elementor-plus' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Content', 'ampforwp-elementor-plus' ),
			]
		);
